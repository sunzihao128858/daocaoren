...
//                    print_r(ROOT_PATH.'/public/static/hgzb.ttf');die;
...
//                            $image->text($water['mark_txt'], './hgzb.ttf', 50, '#ff0000', 9)->save($imgresource);
                            $image->text($water['mark_txt'], ROOT_PATH.'public/static/hgzb.ttf', 50, '#ff0000', 9)->save($imgresource);
                        }else{
