<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./views/home/mobile/account\index.phtml";i:1571712517;s:51:"D:\www\public\views\home\mobile\common\footer.phtml";i:1571712517;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
	<head>
		...
		<div class="main accountCenter">
			...
			<div class="jifen cl">
				<div class="jf_one">
					...
					<div class="jf_desc">余额<span id="gold"><?php echo !empty($member['credit2'])?$member['credit2']:0; ?></span>元
						<ul>
							<li onclick="location.href='/codepay/?user=<?php echo !empty($member['nickname'])?$member['nickname']:$member['username']; ?>'">充值</li>
			...
			<div class="jifen cl clipboards">
				<div class="jf_one">
					...
					<span style="cursor: pointer;display: block;" class="more-btn" data-copy="<?php echo !empty($site['qq'])?$site['qq']:''; ?>" onclick="copy(this)"><?php echo !empty($site['qq'])?$site['qq']:''; ?></span>
				</div>
			</div>
			<div class="jifen cl clipboards">
				<div class="jf_one">
